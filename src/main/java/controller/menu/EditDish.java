...
public class EditDish extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 9.1.2.3 Lấy thông tin món ăn cần cập nhật từ FormData
        ...
        // 9.1.2.5 Tạo và set thuộc tính cho đối tượng Dish
        Dish dish = new Dish();
        dish.setId(id);
        ...
        // 9.1.2.6 Gọi hàm cập nhật món ăn có tham số là món ăn cần cập nhật
